...
// Code Here
let myNumbersIndex = []
myNumbers.forEach(function(arr, index) {
...
// Code Here
const forTheLoveOfGeorge = notGeorge.map(curr => curr = 'George')
//////////////////PROBLEM 19////////////////////
...
// Code Here
const enemies = people.filter(enemy => enemy.friend === false)
//////////////////PROBLEM 20////////////////////
...
// Code Here
// const totallyAwesome = people.reduce((acc, curr) => acc + curr.awesomeLevel)
